const PRODUCTS = [
  {
    ...
    names: { bn: "ফ্লোরাল প্রিন্ট মিডি ড্রেস - গ্রীষ্মকালীন কালেকশন", en: "Floral Print Midi Dress - Summer Collection", ar: "فستان ميدي بطباعة زهرية - كولكشن الصيف" }
  },
  {
    ...
    names: { bn: "কটন কাজু ব্লাউজ - ক্যাজুয়াল উইকেন্ড", en: "Cotton Casual Blouse - Weekend Wear", ar: "بلوزة قطنية كاجوال - ملابس عطلة الأسبوع" }
  },
  {
    ...
    names: { bn: "হাই ওয়েস্ট স্কিনি জিন্স - ট্রেন্ডি লুক", en: "High Waist Skinny Jeans - Trendy Look", ar: "جينز ضيق بخصر عالٍ - إطلالة عصرية" }
  },
  {
    ...
    names: { bn: "এমব্রয়ডারি কুর্তি সেট - উৎসব স্পেশাল", en: "Embroidery Kurti Set - Festival Special", ar: "طقم كورتي مطرز - خاص بالأعياد" }
  },
  {
    ...
    names: { bn: "স্লিম ফিট কটন শার্ট - অফিস কালেকশন", en: "Slim Fit Cotton Shirt - Office Collection", ar: "قميص قطني سليم فيت - كولكشن المكتب" }
  },
  {
    ...
    names: { bn: "কার্গো প্যান্ট - স্ট্রিটওয়্যার এডিশন", en: "Cargo Pants - Streetwear Edition", ar: "بنطلون كارجو - إصدار ستريت وير" }
  },
  {
    ...
    names: { bn: "পোলো টি-শার্ট প্যাক অব থ্রি - ডেইলি ওয়্যার", en: "Polo T-Shirt Pack of Three - Daily Wear", ar: "حزمة تي شيرت بولو 3 قطع - ملابس يومية" }
  },
  {
    ...
    names: { bn: "ফর্মাল ব্লেজার - বিজনেস লুক", en: "Formal Blazer - Business Look", ar: "بليزر رسمي - إطلالة الأعمال" }
  },
  {
    ...
    names: { bn: "কিউট কার্টুন টি-শার্ট - বাচ্চাদের পছন্দের", en: "Cute Cartoon T-Shirt - Kids Favorite", ar: "تي شيرت كرتوني لطيف - المفضل عند الأطفال" }
  },
  {
    ...
    names: { bn: "গার্লস পার্টি ড্রেস - জন্মদিন স্পেশাল", en: "Girls Party Dress - Birthday Special", ar: "فستان سهرة للبنات - خاص بأعياد الميلاد" }
  },
  {
    ...
    names: { bn: "ম্যাট লিপস্টিক কালেকশন - ১২ শেড", en: "Matte Lipstick Collection - 12 Shades", ar: "كولكشن أحمر الشفاه المات - 12 درجة" }
  },
  {
    ...
    names: { bn: "সানস্ক্রিন SPF 50+ - ত্বকের যত্ন", en: "Sunscreen SPF 50+ - Skin Care", ar: "واقي شمس SPF 50+ - العناية بالبشرة" }
  },
  {
    ...
    names: { bn: "ক্যাজুয়াল স্নিকার - কমফোর্ট কালেকশন", en: "Casual Sneaker - Comfort Collection", ar: "حذاء سنيكر كاجوال - كولكشن مريح" }
  },
  {
    ...
    names: { bn: "হিল স্যান্ডেল - পার্টি ওয়্যার", en: "Heel Sandal - Party Wear", ar: "صندل بكعب - ملابس الحفلات" }
  },
  {
    ...
    names: { bn: "লেদার টোট ব্যাগ - ওয়ার্কপ্লেস এসেনশিয়াল", en: "Leather Tote Bag - Workplace Essential", ar: "حقيبة توت جلدية - أساسيات العمل" }
  },
  {
    ...
    names: { bn: "মিনি ক্রসবডি ব্যাগ - ট্রেন্ডি স্টাইল", en: "Mini Crossbody Bag - Trendy Style", ar: "حقيبة كروس بودي صغيرة - ستايل عصري" }
  },
  {
    ...
    names: { bn: "গোল্ড প্লেটেড নেকলেস সেট - ৩ পিস", en: "Gold Plated Necklace Set - 3 Pieces", ar: "طقم قلادة مطلية بالذهب - 3 قطع" }
  },
  {
    ...
    names: { bn: "স্টোন ব্রেসলেট - বোহেমিয়ান ভাইব", en: "Stone Bracelet - Bohemian Vibe", ar: "سوار حجري - إطلالة بوهيمية" }
  },
  {
    ...
    names: { bn: "কটন বেড শিট সেট - কিং সাইজ", en: "Cotton Bed Sheet Set - King Size", ar: "طقم ملاءات قطنية - مقاس كينج" }
  },
  {
    ...
    names: { bn: "অ্যারোমা ক্যান্ডেল সেট - রিল্যাক্সেশন", en: "Aroma Candle Set - Relaxation", ar: "طقم شموع عطرية - للاسترخاء" }
  },
  {
    ...
    names: { bn: "ওয়্যারলেস ইয়ারবাড - নয়েজ ক্যান্সেলিং", en: "Wireless Earbuds - Noise Cancelling", ar: "سماعات لاسلكية - إلغاء الضوضاء" }
  },
  {
    ...
    names: { bn: "স্মার্টওয়াচ - ফিটনেস ট্র্যাকার", en: "Smartwatch - Fitness Tracker", ar: "ساعة ذكية - تتبع اللياقة البدنية" }
  },
  {
    ...
    names: { bn: "ইয়োগা প্যান্ট - হাই ওয়েস্ট ফ্লেক্সি", en: "Yoga Pants - High Waist Flexi", ar: "بنطلون يوجا - خصر عالٍ مرن" }
  },
  {
    ...
    names: { bn: "স্পোর্টস ওয়াটার বটল - ১ লিটার BPA ফ্রি", en: "Sports Water Bottle - 1L BPA Free", ar: "زجاجة مياه رياضية - 1 لتر خالية من BPA" }
  }
];
